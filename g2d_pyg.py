...
def init_canvas(size: (int, int)):
    ...
    global _canvas
    pygame.init()
    pygame.display.set_caption("Moon Patrol") #Changes window name
    icon = pygame.image.load("icon.png") #Loads window icon
    pygame.display.set_icon(icon) #Changes window icon
